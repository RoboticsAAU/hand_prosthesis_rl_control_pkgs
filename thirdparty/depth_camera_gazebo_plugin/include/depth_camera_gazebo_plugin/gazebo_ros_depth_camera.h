...
#ifndef _GAZEBO_ROS_DEPTH_CAMERA_PLUGIN_
#define _GAZEBO_ROS_DEPTH_CAMERA_PLUGIN_
...
class GazeboRosDepthCamera : public DepthCameraPlugin {
  /// \brief Constructor.
public:
...
#endif /* _GAZEBO_ROS_DEPTH_CAMERA_PLUGIN_ */
