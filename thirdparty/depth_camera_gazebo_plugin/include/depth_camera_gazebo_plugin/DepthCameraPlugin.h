/*
// Code adapted from DepthCamera gazebo plugin by Rui Pimentel de Figueiredo
...
*/
// Code adapted from RealSense gazebo plugin by Rui Pimentel de Figueiredo, in order to avoid plushing color and point cloud information
...
/// \brief A plugin that simulates a depth camera.
class DepthCameraPlugin : public ModelPlugin {
  /// \brief Constructor.
public:
  DepthCameraPlugin();
